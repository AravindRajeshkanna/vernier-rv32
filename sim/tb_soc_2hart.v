...
// since this test's own job (prove the hardware wiring, nothing about the
// boot sequence) needs neither the ROM's own SD/UART loader nor its
// mailbox (sim/tb_ramboot_2hart.v, Stage 12, is the test that exercises
// the real boot ROM with two harts specifically).
